...
if __name__ == "__main__":
    ...
    weekly.to_csv(
        "./src/chimeric_tools/data/truth-Incident WeeklyDeaths.csv.gz", index=False, compression="gzip"
    )
    weekly = model(weekly)
    weekly = weekly.rename(columns={"value": "deaths", "preds": "preds_deaths", "residuals": "residuals_deaths"})
